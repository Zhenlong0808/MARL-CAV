...
class MAPPO:
    ...
    def interact(self):
        ...
        for i in range(self.roll_out_n_steps):
            ...
            next_state, global_reward, done, info = self.env.step(tuple(action), self.env)
    ...
    def train(self):
        ...
        for agent_id in range(self.n_agents):
            ...
            actor_loss = -th.mean(th.min(surr1, surr2)) #policy gradient 负号，梯度增加
            actor_loss.backward()
    ...
    def evaluation(self, env, output_dir, eval_episodes=1, is_train=True):
        ...
        for i in range(eval_episodes):
            ...
            while not done:
                ...
                state, reward, done, info = env.step(action, self.env)
