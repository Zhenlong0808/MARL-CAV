...
from common.plot_fn import  plot_reward
import gym
import numpy as np
...
def train(args):
    ...
    while mappo.n_episodes < MAX_EPISODES:
        mappo.interact()
        print("n_episodes", mappo.n_episodes)
...
def evaluate(args):
    ...
    rewards, (vehicle_speed, vehicle_position), steps, avg_speeds = mappo.evaluation(env, video_dir, len(seeds), is_train=False)
...
if __name__ == "__main__":
    args = parse_args()
    # train or eval
    args.option = "train" # "eval"
    args.model_dir = "./results/Feb_13_15_35_37/"
